...
async function handleChangePriority(id) {
  ...
  if (note && selectedValue !== 'all') {
    //console.log(note, selectedValue)
...
if (selectedValue !== 'all') {
  ...
  setAllNotes([...allNotes, response.data]); //despues de agregar, muestra la nueva nota, evitando el Refresh
}
    ...
    <div id="app">
      <aside>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='input-block'>
            <label htmlFor='title'>Anotacoes</label>
            <textarea
            required
              value={notes}
